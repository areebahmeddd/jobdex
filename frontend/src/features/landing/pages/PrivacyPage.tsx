...
export default function PrivacyPage() {
  return (
    <StaticPageLayout title="Privacy Policy" intro="Last updated: July 1, 2026">
      <div className="space-y-10 text-gray-700">
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed">
            ...
            This policy explains what data exists, where it comes from, and how
            it is handled.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed">
            All job listings on JobDex are sourced from public, unauthenticated
            APIs provided by applicant tracking systems such as Greenhouse,
            Lever, Ashby, Workable, SmartRecruiters, and others. This data
            includes job titles, descriptions, locations, and company names.
            None of it is personal data. We do not store resumes, applications,
            or any information submitted by job seekers.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed">
            ...
            donation, you interact directly with Razorpay's checkout interface.
            We never see or store your card number, UPI ID, or bank details.
            Razorpay's privacy policy governs the data they collect during
            payment. We receive only a payment confirmation and a transaction ID
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed">
            If this policy changes in a meaningful way, the updated date at the
            top of this page will reflect it. Since we collect no personal data,
            changes are unlikely to affect you in practice.
          </p>
        </section>
