...
| `unit/test_pagination.py`    | 3     | `_decode_cursor` (error paths)                                                    |
| `unit/test_classifiers.py`   | 73    | `classify_seniority`, `classify_role`, `extract_tech_stack`, `normalize_job_type` |
